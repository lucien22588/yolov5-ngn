...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-im3.yaml', help='model.yaml path')
    ...
    parser.add_argument('--cos-lr', action='store_false', help='cosine LR scheduler')
